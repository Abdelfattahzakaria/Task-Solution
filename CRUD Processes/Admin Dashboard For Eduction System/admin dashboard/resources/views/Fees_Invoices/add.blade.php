            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form class=" row mb-30" action="{{route('feesInvoivesStore')}}" method="post">
                            @csrf
                            @method("POST") 
                            <div class="card-body">
                                <div class="repeater">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="fancyselect" name="student_id" required>
                                                            <option value="{{ $student->id }}">{{ $student->$field }}</option>
                                                    </select>
                                                </div> 
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('classroom_list.processes') }}:</label>
                                                    <input class="btn btn-danger btn-block" data-repeater-delete type="button" value="{{ trans('classroom_list.delete') }}" />
                                                </div>  
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="button" data-repeater-create type="button" value="{{ trans('classroom_list.add_invoice') }}"/> 
                                        </div>
                                    </div><br>
