        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{route('feesUpdate')}}" method="post" autocomplete="off">
                        @csrf   
                        @method("POST")
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Grade_id">
                                    @foreach($Grades as $Grade)
                                        <option value="{{ $Grade->id }}" {{$Grade->id == $fee->grade_id  ? 'selected' : ""}}>{{ $Grade->$Field }}</option>
                                    @endforeach 
                                </select> 
                            </div>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Classroom_id">
                                    <option value="{{$fee->Classroom_id}}">{{$fee->classroom->$Field}}</option> 
                                </select>
                            </div>
                            <div class="form-group col">
