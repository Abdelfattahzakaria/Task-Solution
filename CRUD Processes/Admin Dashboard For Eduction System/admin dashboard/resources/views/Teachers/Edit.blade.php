            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('teacherUpdate')}}" method="post"> 
                             @csrf
                             @method("POST") 
                            <div class="form-row">
                                <div class="col"> 
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="Name_ar" value="{{$Teachers->Name_Ar}}" class="form-control">
                                    @error('Name_ar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" name="Name_en" value="{{$Teachers->Name_En}}" class="form-control">
                                    @error('Name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Specialization_id">
                                        <option value="{{$Teachers->specialtion_id}}">{{$Teachers->specialtion->$field}}</option>
                                        @foreach($specializations as $specialization)
                                            <option value="{{$specialization->id}}">{{$specialization->$field}}</option> 
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Gender_id">
                                        <option value="{{$Teachers->gender_id}}">{{$Teachers->gender->$field}}</option>
                                        @foreach($genders as $gender)
                                            <option value="{{$gender->id}}">{{$gender->$field}}</option>
                                        @endforeach
                                    </select> 
                                    @error('Gender_id')
                                    <div class="alert alert-danger">{{ $message }}</div>
