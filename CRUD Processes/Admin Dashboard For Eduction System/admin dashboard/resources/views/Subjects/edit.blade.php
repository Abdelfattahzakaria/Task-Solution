            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('subjectUpdate')}}" method="post" autocomplete="off">
                                @csrf
                                @method("POST") 
                                <div class="form-row">
                                    <div class="col">
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" name="Grade_id">
                                            ...
                                            @foreach($grades as $grade)
                                                <option
                                                    value="{{$grade->id}}" {{$grade->id == $subject->grade_id ?'selected':''}}>{{$grade->$field }}</option>
                                            @endforeach
                                        </select>
                                    </div> 
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select name="Class_id" class="custom-select">
                                            <option
                                                value="{{ $subject->classroom->id }}">{{ $subject->classroom->$field }}
                                            </option>
                                        </select> 
                                    </div>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select class="custom-select my-1 mr-sm-2" name="teacher_id">
                                            ...
                                            @foreach($teachers as $teacher)
                                                <option
                                                    value="{{$teacher->id}}" {{$teacher->id == $subject->teacher_id ?'selected':''}}>{{$teacher->$Field}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>  
