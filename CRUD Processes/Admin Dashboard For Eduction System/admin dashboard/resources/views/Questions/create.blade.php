    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item active">اضافة الاسئلة</li>
            </ol>
        </div>
    </div>
</div>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        <br>
                        <form action="{{route('questionStore')}}" method="post" autocomplete="off">
                            @csrf  
                            @method("POST")  
                            <div class="form-row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="quizze_id">
                                            ...
                                            <option value="{{ $quizze->id }}">{{ $quizze->$field }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
