                                ...
                                <table class="table table-striped table-hover" style="text-align:center">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{$Student->nationalit->$field}}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $Student->pareent->$father_name}}</td>
                                    ...
                                    <table class="table center-aligned-table mb-0 table table-hover" style="text-align:center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style='text-align:center;vertical-align:middle'>
                                                ...
                                                <td colspan="2">
                                                    <a class="btn btn-outline-info btn-sm" href="{{url('downloadAttachment')}}/{{$Student->name_ar}}/{{$attachment->fileName}}" role="button"><i class="fas fa-download"></i>&nbsp; {{trans('Students_trans.Download')}}</a>
