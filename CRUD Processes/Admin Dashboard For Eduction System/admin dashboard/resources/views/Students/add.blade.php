    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" action="{{route('studentStore')}}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method("POST")
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="nationalitie_id">
                                    ...
                                    <option value="{{ $nal->id }}">{{ $nal->$field  }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-2" name="Grade_id">
                                    ...
                                    <option value="{{ $g->id }}">{{ $g->$field }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
