        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                @endif
                    ...
                    <form action="{{route('studentUpdate')}}" method="post" autocomplete="off"> 
                        @method('POST')
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->name_ar}}" type="text" name="name_ar"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$Students->name_en}}" class="form-control" name="name_en" type="text" >
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="gender_id">
                                        ...
                                        @foreach($Genders as $Gender)
                                            <option value="{{$Gender->id}}" {{$Gender->id == $Students->gender_id ? 'selected' : ""}}>{{ $Gender->$Field }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                        ...
                                        @foreach($nationals as $nal)
                                            <option value="{{ $nal->id }}" {{$nal->id == $Students->nationalit_id  ? 'selected' : ""}}>{{ $nal->$field }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="blood_id">
                                        ...
                                        @foreach($bloods as $bg)
                                            <option value="{{ $bg->id }}" {{$bg->id == $Students->bloodtybe_id ? 'selected' : ""}}>{{ $bg->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Grade_id">
                                        ...
                                        @foreach($Grades as $Grade)
                                            <option value="{{ $Grade->id }}" {{$Grade->id == $Students->grade_id ? 'selected' : ""}}>{{ $Grade->$field }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="parent_id">
                                       ...
                                       @foreach($parents as $parent)
                                            <option value="{{ $parent->id }}" {{ $parent->id == $Students->pareent_id ? 'selected' : ""}}>{{ $parent->$father_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>    
